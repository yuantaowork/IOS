        ...
        case 1:{
            ...
            for (int i = 0; i<_imageNameArry.count; i++) {
                if ([[[_imageNameArry objectAtIndex:i]valueForKey:@"type"]isEqualToString:@"1"]) {
                    ...
                    [imageveiw sd_setImageWithURL:[NSURL URLWithString:namestr] placeholderImage:img options:SDWebImageProgressiveDownload progress:^(NSInteger receivedSize, NSInteger expectedSize) {} completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
                        if (img!=nil) {
                ...
                if ([[[_imageNameArry objectAtIndex:i]valueForKey:@"type"]isEqualToString:@"2"]) {
                    ...
                    [imageveiw1 sd_setImageWithURL:[NSURL URLWithString:namestr] placeholderImage:img options:SDWebImageProgressiveDownload progress:^(NSInteger receivedSize, NSInteger expectedSize) {} completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
                        if (img!=nil) {
                ...
                if ([[[_imageNameArry objectAtIndex:i]valueForKey:@"type"]isEqualToString:@"3"]) {
                    ...
                    [imageveiw2 sd_setImageWithURL:[NSURL URLWithString:namestr] placeholderImage:img options:SDWebImageProgressiveDownload progress:^(NSInteger receivedSize, NSInteger expectedSize) {} completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
                        if (img!=nil) {
