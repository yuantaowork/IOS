...
- (void)layoutSubviews {
    ...
    [self setTitleEdgeInsets:UIEdgeInsetsMake(0.0, -CGRectGetWidth(self.imageView.frame)+40, 0.0, CGRectGetWidth(self.imageView.frame) + self.arrowPadding)];
    [self setImageEdgeInsets:UIEdgeInsetsMake(0.0, CGRectGetWidth(self.titleLabel.frame)+40 + self.arrowPadding, 0.0, -CGRectGetWidth(self.titleLabel.frame))];
